...
public class Testes {
    ...
    public void InicioTeste() {
        navegadores = new Navegadores("Chrome");
    ...
    private void ExecutarCompraEValidarProdutoEmsgFinal(String login_user, String senha_user, By button,
                                                        String validar_produto, String nome_cliente,
                                                        String sobrenome_cliente, String cep_cliente, String msg_final)
            throws IOException {
    ...
    @Test
    public void ValidarTentativaDeLoginComUsuarioBloqueado() throws IOException, InterruptedException {
